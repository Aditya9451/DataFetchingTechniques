package com.tutorial.springboot.cruddemo.swagger;
...
public class SwagerConfig {
	 ...
	 public static final Contact DEFAULT_CONTACT = new Contact(" Aditya Raj", "com.tutorial", "");
	  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(" My Spring Api Documentation", "Api Documentation", "1.0", "urn:tos",
